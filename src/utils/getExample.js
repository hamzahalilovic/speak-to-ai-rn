...
import {MIDDLEWARE_API_URL, XMIDDLEWARE_API_URL} from '@env';

export const newExample = async (
  fetchWithTimeout,
  sessionID,
  knowledgebaseId,
  lang,
  ...
  try {
    ...
    exampleResponse = await fetchWithTimeout(`${XMIDDLEWARE_API_URL}examples`, {
      method: 'POST',
      timeout: 25000,
      headers: {
